      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Contoh Pengisian Laporan" maxWidth="max-w-2xl">
        <div className="space-y-5 text-sm">
          ...
          <div>
            ...
            <div className="space-y-1.5 text-slate-700">
              <p>
                ...
                Melebihi target entri data sebanyak 10 dokumen
              </p>
              <p>
                <span className="font-semibold">Kualitas: </span>
                Data lolos validasi, tidak ada outlier
              </p>
              <p>
                <span className="font-semibold">Waktu: </span>
                Semua tugas selesai sesuai jam kerja
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1.5 text-slate-700">
              <p>
                ...
                Server BPS pusat maintenance jam 10.00-11.00 sehingga upload data tertunda
              </p>
              <p>
                <span className="font-semibold">Solusi: </span>
                Pekerjaan dialihkan ke desain infografis dulu, upload dilanjut jam 13.00
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-500">
              Opsional — isi jika ada informasi tambahan yang perlu disampaikan, atau kosongkan
              jika tidak ada.
            </p>
          </div>
        </div>
